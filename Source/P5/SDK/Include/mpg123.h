...
extern unsigned int   get1bit(struct mpstr *_pMP);
extern unsigned int   getbits(struct mpstr *_pMP, int);
extern unsigned int   getbits_fast(struct mpstr *_pMP, int);
extern int set_pointer(struct mpstr *_pMP, long);

extern void make_decode_tables(long scaleval);
extern int do_layer3(struct mpstr *_pMP, struct frame *fr,unsigned char *,int *);
extern int do_layer2(struct mpstr *_pMP, struct frame *fr,unsigned char *,int *);
extern int do_layer1(struct mpstr *_pMP, struct frame *fr,unsigned char *,int *);
extern int decode_header(struct mpstr *_pMP, struct frame *fr,unsigned long newhead);
...
extern int synth_1to1 (struct mpstr *_pMP, real *,int,unsigned char *,int *);
extern int synth_1to1_8bit (real *,int,unsigned char *,int *);
extern int synth_1to1_mono (struct mpstr *_pMP, real *,unsigned char *,int *);
